...
kp_nondimer = kpoly(p_occ_nondimer,p_r_nondimer,pocc_base_nondimer,c_PA,G,k_cap,k_del,r_cap,r_cap_exp,prm_size);
...
h.XLabel = "log_{2}(1-p_{occ} dimerized/1-p_{occ} non-dimerized)";
    ...
    function kpratio = kpolyratio(p_occ_comp_ratio, p_r_ratio)
        ...
        kp_dimer = kpoly(p_occ_dimer,p_r_dimer,pocc_base_dimer,c_PA,G,k_cap,k_del,r_cap,r_cap_exp,prm_size);
