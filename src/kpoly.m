function kp = kpoly(p_occ,p_r,pocc_base,c_PA,G,k_cap,k_del,r_cap,r_cap_exp,prm_size)
%KPOLY Computes the rate of polymerization for a single binding site (PRM)
    % kp=
    %   KPOLY(p_occ,p_r,pocc_base,c_PA,k_cap,G,k_del,r_cap,r_cap_exp,prm_size) computes the rate of
    %   elongation
    %
    %   Inputs:
